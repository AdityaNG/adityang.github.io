...
function D3Nav() {
  ...
  const title = "D³Nav: Data-Driven Driving Agents for Autonomous Vehicles in Unstructured Traffic"
  const authors = [
    {
  ...
  const image = require("./media/d3nav_demo_0_future_video_prediction.gif")
  ...
  return (
    <div className="container">
      ...
      <Grid container spacing={0} style={{ overflow: 'hidden', maxHeight: '80vh', background: '#000000'}}>
        {GridGifs.map((gif, index) => {
    
          return (
          <Grid item xs={6} sm={6} md={4} lg={3} key={index} style={{ padding: '0', backgroundColor: hasError ? 'black' : 'transparent' }}>
